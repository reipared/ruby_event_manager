...
def legislators_by_zipcode(zip)
  ...
  begin
    civic_info.representative_info_by_addres(
        address: zip,
        levels: 'country',
...
def save_thank_you_letter(id, form_letter)
  Dir.mkdit("output") unless Dir.exists?("output")
...
puts "Most Active House is: #{count_frequency(hour_of_day)}"
